...
function Strategy(options, verify) {
    ...
    if (!verify) {
        throw new TypeError("PharmaTrace Web3 verification");
    }
...
Strategy.prototype.authenticate = function(req, options) {
    ...
    this._store.verify(req, siwwMessage.payload.nonce, function(err, ok, info) {
        ...
        siwwMessage
            .verify(req.body.payload, req.body.signature, req.body.network)
            .then(function(ok) {
                console.log(ok);
                ...
                try {
                    if (self._passReqToCallback) {
                        ...
                        switch (arity) {
                            default: return self._verify(
                                siwwMessage.payload.address,
                                siwwMessage.network,
                                verified
                            );
                        }
